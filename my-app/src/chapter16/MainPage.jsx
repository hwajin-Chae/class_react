  ...
  return (
    <div>
      ...
      <ul>
        ...
        {/* 방법 2 : a 태그 역할의 Link 컴포넌트 */}
        { /* 차이점?
        a 태그의 기본동작은 페이지를 이동 시키면서, 페이지를 아예 새로 불러옴(새로고침)
        그렇게 되면 리액트 앱이 지니고 있는 상태들도 초기화 되고,
        컴포넌트들도 새로 렌더링을 하게 됨 */}
        {/* a 태그의 사용이 필요하다면, Link 컴포넌트를 사용 */}
        {/* Link 컴포넌트 = 새로고침을 막아놓은 a 태그 */}
        <li>
